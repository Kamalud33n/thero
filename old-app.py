...
# matplotlib is used only to render the PDF report's progress chart to a
# PNG that gets embedded via RLImage. Agg backend = no display needed.
import io
import matplotlib
matplotlib.use("Agg")
...
def gen_frames():
    ...
    try:
        ...
        while _mjpeg_active:
            ...
            if person_found and _mp_drawing is not None:
